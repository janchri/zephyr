...
#elif defined(CONFIG_SOC_SERIES_EFM32PG23)
#include <zephyr/dt-bindings/clock/silabs/pg23-clock.h>
#elif defined(CONFIG_SOC_SERIES_EFM32PG28)
#include <zephyr/dt-bindings/clock/silabs/pg28-clock.h>
