...
#ifndef ZEPHYR_INCLUDE_DT_BINDINGS_CLOCK_SILABS_PG23_CLOCK_H_
#define ZEPHYR_INCLUDE_DT_BINDINGS_CLOCK_SILABS_PG23_CLOCK_H_
...
#endif /* ZEPHYR_INCLUDE_DT_BINDINGS_CLOCK_SILABS_PG23_CLOCK_H_ */
